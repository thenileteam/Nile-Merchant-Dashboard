...
import { image, nilelogowhite, notification, starhalf, starsquare, star, commentblock, bitcoingraph, bitcoinbag, bitcoin, bitcoindown, moneysend } from '../assets';
    ...
    <>
        ...
        <div className="flex-grow lg:ml-64">
            ...
            <div className='px-24 mt-32'>
                <div>
                    <img src={moneysend} alt="" className='flex justify-center mx-auto'/>
                    <h1 className='text-[24px] font-extrabold text-center'>Nothing To See Yet</h1>
                    <p className='text-[#6E6E6E] font-bold text-center'>Go Make sales and request for your funds here</p>
                </div>
                <div className='flex justify-center mt-3'>
                    <Link to="/dashboard"><button className='text-[#ffffff] bg-[#004324] p-3 font-bold rounded-md'>Go To Dashboard</button></Link>
                </div>
            </div>
        </div>
        </div>
