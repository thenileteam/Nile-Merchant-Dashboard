...
import { image, nilelogowhite, notification, trolley, shoppingcart, truck1, timer, shoppingcartremove } from '../assets';
    ...
    <>
        ...
        <div className="flex-grow lg:ml-64">
            ...
            <div className='px-24 mt-32'>
                <div>
                    <img src={shoppingcartremove} alt="" className='flex justify-center mx-auto'/>
                    <h1 className='text-[24px] font-extrabold text-center'>You Have No orders Yet</h1>
                    <p className='text-[#6E6E6E] font-bold text-center'>You’ll get notified when you receive your first order</p>
                </div>
