...
import { image, nilelogowhite, notification, starhalf, starsquare, star, commentblock, userlist, usergroup, usercheck, userarrow, userblock } from '../assets';
        ...
        <div className="flex-grow lg:ml-64">
            ...
            <div className='flex items-center justify-between'>
                <div className='flex items-center gap-2 px-20'>
                    ...
                    <h1 className="text-[32px] font-bold">Customers Management </h1>
                </div>
            ...
            <div className="p-6 mt-28 px-32">
                <div className='flex gap-28'>
                    <div className='bg-[#FFFFFF] border-2 shadow-sm w-[273px] p-5 rounded-md'>
                        ...
                        <h1 className='text-[#333333] text-[22px] font-bold mt-1'>0</h1>
            ...
            <div className='px-24 mt-20'>
                <div>
                    <img src={userblock} alt="" className='flex justify-center mx-auto'/>
                    <h1 className='text-[24px] font-extrabold text-center'>You Have No Customers</h1>
                    <p className='text-[#6E6E6E] font-bold text-center'>Once a customer buy from you or you <br /> added a customer manually,they will <br /> appear here.</p>
                </div>
                <div className='flex justify-center mt-3'>
                    <button className='text-[#ffffff] bg-[#004324] p-3 font-bold rounded-md'>Add Customers</button>
                </div>
            </div>
