...
import { image, nilelogowhite, notification, starhalf, starsquare, star, commentblock, bitcoingraph, bitcoinbag, bitcoin, bitcoindown, moneysend, notification1, comment } from '../assets';
    ...
    <>
        ...
        <div className="flex-grow lg:ml-64">
            ...
            <div className='px-24 mt-72'>
                <div>
                    <img src={comment} alt="" className='flex justify-center mx-auto'/>
                    <h1 className='text-[24px] font-extrabold text-center'>Nothing To See Yet</h1>
                    <p className='text-[#6E6E6E] font-bold text-center'>Your Notifications Will Show Here Once <br /> There’s One</p>
                </div>
