...
const SignUp = () => {
  ...
  return (
    <section>
      <div className="container md:max-w-[700px] lg:max-w-[1184px] mx-auto mt-28 lg:flex gap-[120px] items-center bg-dimWhite rounded-lg p-8 lg:p-16 lg:shadow-md lg:shadow-gray-300">
