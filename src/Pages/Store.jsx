...
const Store = () => {
  ...
  return (
    <>
        ...
        >
            <img src={nilelogowhite} alt="" className='w-[170px] flex mx-auto'/>
            <Links />
        </div>
                ...
                <Link to="/profilesetting">
                  <div className='flex items-center justify-between bg-[#EAF4E2] border-[#8ED06C] border-2 rounded-md w-[322.89px] h-[192px] p-5'>
                    <div>
                      ...
                      <div className='mt-5'>
                        <h1 className='text-[#333333] font-bold'>Profile Settings</h1>
                        <p className='text-[#6E6E6E]'>Provide personal details and how you log in to your store</p>
                      </div>
                    </div>
                    <div>
                ...
                <Link to="/storesetting">
                  <div className='flex items-center justify-between bg-[#EAF4E2] border-[#8ED06C] border-2 rounded-md w-[322.89px] p-5'>
                    <div>
                      <img src={store} alt=""/>
                      <div className='mt-5'>
                        <h1 className='text-[#333333] font-bold'>Store Settings</h1>
                        <p className='text-[#6E6E6E]'>Provide right informations your store need and set up how your store should look</p>
                      </div>
                    </div>
                    <div>
                ...
                <Link to="/paymentsetting">
                  <div className='flex items-center justify-between bg-[#EAF4E2] border-[#8ED06C] border-2 rounded-md w-[322.89px] h-[192px] p-5'>
                    <div>
                      <img src={dollar} alt="" />
                      <div className='mt-5'>
                        <h1 className='text-[#333333] font-bold'>Payment & Checkout Settings</h1>
                        <p className='text-[#6E6E6E]'>Manage your store’s payment options and checkout preferences</p>
                      </div>
                    </div>
                    <div>
                ...
                <Link to="/usersetting">
                  <div className='flex items-center justify-between bg-[#EAF4E2] border-[#8ED06C] border-2 rounded-md w-[322.89px] p-5'>
                    <div>
                      <img src={profile} alt="" />
                      <div className='mt-5'>
                        <h1 className='text-[#333333] font-bold'>Users & Permission Settings</h1>
                        <p className='text-[#6E6E6E]'>Manage the team members who have access to your store and assign them the appropriate roles and permission.</p>
                      </div>
                    </div>
                    <div>
                ...
                <Link to="/notificationsetting">
                  <div className='flex items-center justify-between bg-[#EAF4E2] border-[#8ED06C] border-2 rounded-md w-[322.89px] h-[216px] p-5'>
                    <div>
                      ...
                      <div className='mt-5'>
                        <h1 className='text-[#333333] font-bold'>Notifications Settings</h1>
                        <p className='text-[#6E6E6E]'>Choose how you want to receive update on your store activity,updates and suspicious activity on your account</p>
                      </div>
                    </div>
                    <div>
                      <img src={arrow} alt="" className='w-16'/>
                ...
                <Link to="/banksetting">
                  <div className='flex items-center justify-between bg-[#EAF4E2] border-[#8ED06C] border-2 rounded-md w-[322.89px] h-[213px] p-3'>
                    <div>
                      <img src={bank} alt="" />
                      <div className='mt-5'>
                        <h1 className='text-[#333333] font-bold'>Bank Settings</h1>
                        <p className='text-[#6E6E6E]'>Set how you want to receive payout directly from your App.</p>
                      </div>
                    </div>
                    <div>
                      <img src={arrow} alt="" className='w-9'/>
                ...
                <Link to="/plansetting">
                  <div className='flex items-center justify-between bg-[#EAF4E2] border-[#8ED06C] border-2 rounded-md w-[322.89px] p-3'>
                    <div>
                      <img src={invoice} alt="" />
                      <div className='mt-5'>
                        <h1 className='text-[#333333] font-bold'>Plan & Billing Settings</h1>
                        <p className='text-[#6E6E6E]'>Upgrade your account and choose your preferable way of paying your subscription</p>
                      </div>
                    </div>
                    <div>
                ...
                <Link to="/shippingsetting">
                  <div className='flex items-center justify-between bg-[#EAF4E2] border-[#8ED06C] border-2 rounded-md w-[322.89px] p-3'>
                    <div>
                      ...
                      <div className='mt-5'>
                        <h1 className='text-[#333333] font-bold'>Shipping & Delivery Settings</h1>
                        <p className='text-[#6E6E6E]'>Manage your shipping preferences,rates and delivery options.</p>
                      </div>
                    </div>
                    <div>
                      <img src={arrow} alt="" className='w-9'/>
                ...
                <Link to="/domainsetting">
                  <div className='flex items-center justify-between bg-[#EAF4E2] border-[#8ED06C] border-2 rounded-md w-[322.89px] p-3'>
                    <div>
                      ...
                      <div className='mt-5'>
                        <h1 className='text-[#333333] font-bold'>Domain Management</h1>
                        <p className='text-[#6E6E6E]'>Get your personalized paid domain from Nile or connect your existing domain to your store.</p>
                      </div>
                    </div>
                    <div>
                      <img src={arrow} alt="" className='w-12'/>
