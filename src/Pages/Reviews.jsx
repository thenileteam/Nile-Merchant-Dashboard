...
import { image, nilelogowhite, notification, starhalf, starsquare, star, commentblock } from '../assets';
    ...
    <>
        ...
        <div className="flex-grow lg:ml-64">
            ...
            <div className='px-24 mt-20'>
                <div>
                    <img src={commentblock} alt="" className='flex justify-center mx-auto'/>
                    <h1 className='text-[24px] font-extrabold text-center'>You’ll Hear Your Customer’s <br /> Voices Here</h1>
                    <p className='text-[#6E6E6E] font-bold text-center'>When your customers give feedbacks on <br /> your product it will show here and you’ll <br /> be notified</p>
                </div>
                <div className='flex justify-center mt-3'>
                    <button className='text-[#ffffff] bg-[#004324] p-3 font-bold rounded-md'>Check Your Customers</button>
                </div>
            </div>
        </div>
        </div>
