...
const EditLocation = ({ location }) => {
  ...
  return (
    <div>
      <button className="hover:scale-110 duration-300 hover:border-lightBlack border-[#ffffff] border-b-[2px] transition underline-offset-2 decoration-[2px] inline-block hover:-translate-x-1" onClick={() => {
        ...
        <div className={`bg-[rgba(0,0,0,0.4)] fixed inset-0 z-50 backdrop-blur-sm ${editLocation?"visible":'invisible'}`}>
          ...
          <form
            className="bg-white p-8">
              <div className=" ">
                <h2 className="text-[32px] border-b border-lightBlack my-6">Edit Branch</h2>
              {/* location Name */}
              <div className="">
                <label
            ...
            <button
              type="button"
              className="bg-green text-white w-full p-2 rounded-md block mx-auto mt-5 hover:bg-[#004315] transitions"
