        ...
        <table className=" w-full border-separate border-spacing-y-5">
            ...
            <tr className='bg-[#ffffff] shadow-md'>
                ...
                <td className="px-2 py-3 text-center bg-[#F5F5F5] text-[#8ED06C] font-extrabold">
                    <Link to="/allorders" className="hover:border-[#8ED06C] border-[#f5f5f5] border-b-2 transition duration-300 underline-offset-4 decoration-[2px] inline-block hover:-translate-x-1">View Orders</Link>
                </td>
            </tr>
            ...
            <tr className='bg-[#ffffff] shadow-md'>
                ...
                <td className="px-2 py-3 text-center bg-[#F5F5F5] text-[#8ED06C] font-extrabold">
                    <Link to="/neworders" className="hover:border-[#8ED06C] border-[#f5f5f5] border-b-2 transition duration-300 underline-offset-4 decoration-[2px] inline-block hover:-translate-x-1">View</Link>
                </td>
            </tr>
            ...
            <tr className='bg-[#ffffff] shadow-md'>
                ...
                <td className="px-2 py-3 text-center">6750</td>
                <td className="px-2 py-3 text-center bg-[#F5F5F5] text-[#8ED06C] font-extrabold">
                    <Link to="/pendingorders" className="hover:border-[#8ED06C] border-[#f5f5f5] border-b-2 transition duration-300 underline-offset-4 decoration-[2px] inline-block hover:-translate-x-1">View</Link>
                </td>
            </tr>
            </tbody>
        </table>
