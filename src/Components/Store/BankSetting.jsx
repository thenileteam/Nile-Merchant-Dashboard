    ...
    <div>
        ...
        <div>
            <div className='text-center'>
                <h1 className='text-[#004324] text-[24px] font-bold'>Input Your Bank Details</h1>
                <p className='text-[#6E6E6E]'>The Bank Informations You Provide Below Will Be <br /> Sent Your Funds To So,Check It Properly And <br /> Confirm</p>
            </div>
                ...
                <form action="#" className='space-y-5'>
                    <div>
                        ...
                        {isDropdownOpen && (
                            ...
                            <ul className="p-2">
                                <li className="py-2 px-4 hover:bg-gray-100 cursor-pointer" onClick={() => handleBankSelection('Bank 1')}>Bank 1</li>
                                <li className="py-2 px-4 hover:bg-gray-100 cursor-pointer" onClick={() => handleBankSelection('Bank 2')}>Bank 2</li>
                                <li className="py-2 px-4 hover:bg-gray-100 cursor-pointer" onClick={() => handleBankSelection('Bank 3')}>Bank 3</li>
                                <li className="py-2 px-4 hover:bg-gray-100 cursor-pointer" onClick={() => handleBankSelection('Bank 4')}>Bank 4</li>
                            </ul>
                            </div>
                        )}
                    </div>
                    <div>
                        <label htmlFor="AccountName" className="block text-[16px] font-bold text-[#333333]">
                    ...
                    <div>
                        <label htmlFor="AccountNumber" className="block text-[16px] font-bold text-[#333333]">
                        Account Number
                        </label>
                    ...
                    <div className='space-y-3'>
                        <h1 className='text-[#333333] text-[16px] font-bold'>Select Payout Schedule</h1>
            ...
            <div className='flex items-center justify-center gap-16 mt-10'>
                <button className='border-[#004324] border-2 text-[#ffffff] bg-[#004324] font-bold p-3 rounded-lg w-[192px]'>Save Changes</button>
            </div>
        </div>
    </div>
  )
