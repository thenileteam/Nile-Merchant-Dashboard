        ...
        <div>
            ...
            <div className='flex justify-center'>
                <div className='space-y-3 bg-[#EAF4E2] border-[#8ED06C] border-2 p-5 rounded-lg'>
                    <h1 className='text-[#333333] text-[18px] font-bold'>Choose Your Shipping Method</h1>
                    <div className='flex items-center justify-between bg-[#ffffff] border-[#8ED06C] border-2 p-2 rounded-md w-[325px]'>
                        <h1 className='text-gray-500 font-bold'>Handle Shipping Yourself</h1>
                    ...
                    <div className='flex items-center justify-between bg-[#ffffff] border-[#8ED06C] border-2 p-2 rounded-md w-[325px]'>
                        <h1 className='text-gray-500 font-bold'>Use In-App Shipping Services</h1>
                        <div className="flex items-center">
                            &#8203;
                            <input type="checkbox" className="size-4 rounded border-gray-300" id="Option2" />
                        </div>
