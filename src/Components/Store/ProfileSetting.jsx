...
import { arrowleft, image, logout, notification, profileimage, store1 } from '../../assets'
        ...
        <div>
            ...
            <div className='flex justify-center'>
                <form action="#" className='space-y-5'>
                    ...
                    <div>
                        <label htmlFor="PhoneNumber" className="block text-[16px] font-bold text-[#333333]">
                        Phone Number
                        </label>
            ...
            <div className='flex items-center justify-center gap-16 mt-10'>
                <button className='border-[#004324] border-2 text-[#004324] font-bold p-3 rounded-lg w-[192px]'>Cancel Changes</button>
