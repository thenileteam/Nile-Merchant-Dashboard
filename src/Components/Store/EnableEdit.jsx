...
const EnableEdit = ({ text, buttonKey }) => {
    const{setEnableEditMode} = useEnableEdit()
  return (
          <button
            type="button"
            className="text-green border border-green p-2 rounded-lg font-semibold flex items-center gap-1 w-fit" onClick={()=>setEnableEditMode(buttonKey)}
          >
            <svg
              width="24"
              height="24"
