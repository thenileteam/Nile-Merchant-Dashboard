...
const StoreSetting = () => {
  return (
    <>
      <div className="mt-20">
        {/* Input Fields */}
        <div className="flex justify-center gap-28 lg:max-w-[1000px] mx-auto">
          <form
            action="#"
            className="space-y-5 bg-[#EAF4E2] border-[#8ED06C] border-2 max-w-[338px] p-4 rounded-lg"
          >
            <div>
              <label
                htmlFor="store-logo"
              ...
              <UploadImage image={addImage} style='w-[185px] mx-0' parentStyle='mt-2'labelFor='logo-upload' />
            </div>
            <div>
              <label
                htmlFor="store-logo"
          ...
          <form
            action="#"
            className=" bg-[#EAF4E2] border-[#8ED06C] border-2 w-[360px] p-4 rounded-lg"
          >
            <div>
              <label
                htmlFor="facebook"
