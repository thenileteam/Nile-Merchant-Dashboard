...
const RequestPayout = () => {
  ...
  return (
    <div>
      <h1
        className="text-[#004324] flex font-bold gap-1 items-center border-[#004324] hover:bg-[#004324] hover:text-[#ffffff] duration-500 border-2 p-2 rounded-sm cursor-pointer"
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
          <div className="bg-[#f5f5f5] p-16 rounded-md shadow-lg w-[553px] h-[377px]">
            ...
            <div className="flex justify-center gap-20 mt-12">
              ...
              >
                <h1 className="hover:text-[#004324] duration-500 flex font-bold gap-1 items-center border-[#004324] bg-[#004324] hover:bg-[#f5f5f5] text-[#ffffff] border-2 p-2 rounded-sm cursor-pointer">
                  <div>
                    <svg
                      width="25"
                      height="24"
