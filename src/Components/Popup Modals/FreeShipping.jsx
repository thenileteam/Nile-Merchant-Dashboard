...
const FreeShipping = ({ isVisible, onClose }) => {
              ...
              <div>
                <div className="relative">
                  ...
                  <select
                    name=""
                    id=""
                    className="w-full rounded-lg border-[#EAF4E2] border-2 py-2.5 pe-10 text-gray-700 sm:text-sm p-3 appearance-none cursor-pointer"
                  >
                ...
                <div className="relative">
                  <label
                    htmlFor=""
                    className="block text-[16px] font-bold text-[#333333] mt-3"
                  >
                    {" "}
