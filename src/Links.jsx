              ...
              >
                ...
                >
                  <path
                    ...
                    stroke={isActive("/dashboard") ?"#fff": "#004324"}
                    strokeWidth="1.5"
                  />
                  <path
              ...
              >
                ...
                >
                  <path
                    ...
                    stroke={isActive("/orders")  ?"#fff": "#004324"}
                    strokeWidth="1.5"
                    strokeLinecap="round"
                  />
                  <path
              ...
              >
                ...
                >
                  <path
                    ...
                    stroke={isActive("/product")  ?"#fff": "#004324"}
                    strokeWidth="1.5"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                  />
              ...
              >
                ...
                >
                  <path
                    ...
                    stroke={isActive("/customer") ?"#fff": "#004324"}
                    strokeWidth="1.5"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                  />
              ...
              >
                ...
                >
                  <path
                    opacity="0.4"
                    d="M20 17.6406H4"
                    stroke={isActive("/financial")  ?"#fff": "#004324"}
                    strokeWidth="1.5"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                  />
        ...
        <footer className="fixed bottom-2">
          <div className="">
            ...
            <div className="flex">
              ...
              <span className="bg-blue-500 p-1 rounded-md text-white">beta</span>
            </div>
          </div>
        </footer>
      )}
